<?php
/**
* Cinema Plugin  - Joomla 4.0.1 Plugin 
* Version			: 1.0.0
...
class plgtaskCinemaInstallerScript
{
	private $min_joomla_version      = '4.1.0';
	private $min_php_version         = '7.2';
	private $name                    = 'Plugin Cinema';
	private $exttype                 = 'plugin';
	private $extname                 = 'cinema';
	private $previous_version        = '';
	private $dir           = null;
	private $installerName = 'plgtaskcinemainstaller';
	...
	private function postinstall_cleanup() {
        ...
        try {
            ...
            JLog::add('unable to enable plugin cinema', JLog::ERROR, 'jerror');
        }
